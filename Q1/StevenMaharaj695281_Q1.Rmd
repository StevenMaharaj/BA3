...
Possible bias - Expectation propagation is data point specific so it may not be a global approximation to the posterior. In other words Expectation propagation may not able to generalise. Therefore, out of sample result my not be as accurate as the in-sample results above.
